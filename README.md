...
Kindly download the pretrained weights of the vgg16 network (vgg16.npy) from the [**Releases** tab](https://github.com/ngfuong/Grad_CAM_plus_plus/releases/tag/v1.0), and copy the file to the `models/` subdirectory.
